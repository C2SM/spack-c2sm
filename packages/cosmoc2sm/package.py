...
def get_releases(repo):
        ...
        git_tags = [tag for tag in git_tags if "{}" not in tag]
        return git_tags
...
class Cosmoc2sm(MakefilePackage):
    """COSMO: Numerical Weather Prediction Model. Needs access to private GitHub."""

    homepage = "http://www.cosmo-model.org"
    url      = "https://github.com/C2SM-RCM/cosmo-1/archive/5.07.tar.gz"
    git      = 'git@github.com:C2SM-RCM/cosmo-1.git'
    maintainers = ['katieosterried']
