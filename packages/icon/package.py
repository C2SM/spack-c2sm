...
class Icon(Package):
    ...
    version('nwp', git='git@gitlab.dkrz.de:icon/icon-nwp.git')
    version('cscs', git='git@gitlab.dkrz.de:icon/icon-cscs.git')
    version('aes', git='git@gitlab.dkrz.de:icon/icon-aes.git' )
