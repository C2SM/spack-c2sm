...
class CosmoEccodesDefinitions(Package):
    ...
    depends_on('eccodes')
    depends_on('eccodes@2.19.0', type='run', when='@2.19.0.1:')
    depends_on('eccodes@2.18.0', type='run', when='@2.18.0.1')
    depends_on('eccodes@2.14.1', type='run', when='@2.14.1.1:2.14.1.2')
