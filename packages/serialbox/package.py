...
class Serialbox(CMakePackage):
    ...
    variant('testing_gridtools', default=True, description='Build with testing gridtools')
    variant('testing_fortran', default=True, description='Build with testing fortran')
    variant('testing_stella', default=True, description='Build with testing stella')
    variant('netcdf', default=True, description='Build using netcdf')
