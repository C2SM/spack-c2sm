...
class CosmoDycore(CMakePackage):
    ...
    apngit = "https://github.com/MeteoSwiss-APN/cosmo.git"
    c2smgit = "https://github.com/C2SM-RCM/cosmo.git"
    empagit = 'https://github.com/C2SM-RCM/cosmo-ghg.git'
    ...
    version('apn-mch',
            ...
            branch='mch')
    version('c2sm-master',
            git='https://github.com/C2SM-RCM/cosmo.git',
            branch='master')
