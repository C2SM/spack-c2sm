...
class CosmoDycore(CMakePackage):
    ...
    variant('slurm_partition', default='debug', description='Slurm partition for testing')

    variant('slurm_gpu', default='--gres=gpu:{0}', description='Slurm GPU reservation for testing')
    ...
    variant('slurm_opt_account', default='', description='Slurm option to specify account for testing')
    variant('slurm_account', default='', description='Slurm option to specify account for testing')

    variant('slurm_opt_constraint', default='', description='Slurm option to specify constraints for nodes requested')
    variant('slurm_constraint', default='', description='Slurm constraints for nodes requested')
