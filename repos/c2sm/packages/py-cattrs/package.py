...
# copy of https://github.com/spack/spack/blob/develop/var/spack/repos/builtin/packages/py-cattrs/package.py
class PyCattrs(PythonPackage):
    ...
    version("22.2.0",
            sha256=
            "f0eed5642399423cf656e7b66ce92cdc5b963ecafd041d1b24d136fdde7acf6d")
