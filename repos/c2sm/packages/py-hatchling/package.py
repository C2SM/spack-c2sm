...
class PyHatchling(PythonPackage):
    ...
    version("1.21.0",
            sha256=
            "5c086772357a50723b825fd5da5278ac7e3697cdf7797d07541a6c90b6ff754c")
    version("1.18.0",
            sha256=
    ...
    version("1.14.0",
            sha256=
            "462ea91df03ff5d52813b5613fec1313a1a2059d2e37343e572b3f979867c5da")
    version("1.13.0",
            sha256=
            "f8d275a2cc720735286b7c2e2bc35da05761e6d3695c2fa416550395f10c53c7")
    version("1.10.0",
            sha256=
            "5d31f43dffaf6265c808e1b5353662ffa5146d844278b55caa6c7f74f427ec50")
    version("1.8.1",
            sha256=
            "448b04b23faed669b2b565b998ac955af4feea66c5deed3a1212ac9399d2e1cd")
    version("1.4.1",
            sha256=
            "13461b42876ade4f75ee5d2a2c656b288ca0aab7f048ef66657ef166996b2118")
    ...
    #WORKAROUND: py-pluggy@1: and py-tox' py-pluggy@0.12.0:0 are incompatible
    #depends_on("py-pluggy@1:", type=("build", "run"))
    depends_on("py-pluggy@0.12:", type=("build", "run"))
