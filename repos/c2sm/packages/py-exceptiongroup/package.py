...
# copy of https://github.com/spack/spack/blob/develop/var/spack/repos/builtin/packages/py-exceptiongroup/package.py
class PyExceptiongroup(PythonPackage):
    ...
    version("1.0.4",
            sha256=
            "bd14967b79cd9bdb54d97323216f8fdf533e278df937aa2a90089e7d6e06e5ec")
