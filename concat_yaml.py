...
joint_compilers=remove_duplicate_entries(c2sm_compilers,cscs_compilers,['compiler','spec'])

joint_yaml={}
joint_yaml['compilers']=joint_compilers
yaml.safe_dump(joint_yaml,open('sysconfigs/daint/compilers.yaml', 'w'),default_flow_style=False)

c2sm_packages=load_from_yaml('sysconfigs/daint/packages.yaml')['packages']
cscs_packages=load_from_yaml(f'{spack_config_root}/packages.yaml')['packages']
...
yaml.safe_dump(joint_yaml,open('sysconfigs/daint/packages.yaml', 'w'),default_flow_style=False)
