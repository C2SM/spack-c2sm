...
# packages
c2sm_packages = load_from_yaml('sysconfigs/templates/daint/packages.yaml')['packages']
...
joint_packages = remove_duplicate_packages(c2sm_packages,cscs_packages,external_packages)
